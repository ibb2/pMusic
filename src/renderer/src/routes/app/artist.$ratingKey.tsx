    ...
    <div className="flex flex-col overflow-y-scroll scrollbar-hidden h-full p-6 mb-20">
      ...
      <div className="mb-8">
        ...
        <div className="bg-slate-300/10 rounded-lg">
          {queryArtistPopularTracks.data.tracks.map(
        ...
        <div className="flex flex-row gap-4">
          {queryArtistAlbums.data.map((album: any) => (
            ...
            >
              <Card
                key={album.id}
                className="flex p-4 justify-center min-w-36 h-48 shrink-0"
              >
